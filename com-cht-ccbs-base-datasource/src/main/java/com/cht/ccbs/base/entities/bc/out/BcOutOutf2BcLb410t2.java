...
/**
 * The persistent class for the bc_out_outf2_bc_lb410t2 database table.
 * 
 */
@Entity
@Table(name="bc_out_outf2_bc_lb410t2")
@NamedQuery(name="BcOutOutf2BcLb410t2.findAll", query="SELECT b FROM BcOutOutf2BcLb410t2 b")
public class BcOutOutf2BcLb410t2 implements Serializable {
