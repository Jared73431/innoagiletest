...
/**
 * The persistent class for the bc_out_outf3_bc_lb410t2 database table.
 * 
 */
@Entity
@Table(name="bc_out_outf3_bc_lb410t2")
@NamedQuery(name="BcOutOutf3BcLb410t2.findAll", query="SELECT b FROM BcOutOutf3BcLb410t2 b")
public class BcOutOutf3BcLb410t2 implements Serializable {
