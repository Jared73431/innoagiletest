...
/**
 * The persistent class for the bc_out_lb747t6 database table.
 * 
 */
@Entity
@Table(name="bc_out_lb747t6")
@NamedQuery(name="BcOutLb747t6.findAll", query="SELECT b FROM BcOutLb747t6 b")
public class BcOutLb747t6 implements Serializable {
