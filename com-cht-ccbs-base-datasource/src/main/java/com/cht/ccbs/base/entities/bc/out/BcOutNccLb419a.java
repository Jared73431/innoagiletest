...
/**
 * The persistent class for the bc_out_ncc_lb419a database table.
 * 
 */
@Entity
@Table(name="bc_out_ncc_lb419a")
@NamedQuery(name="BcOutNccLb419a.findAll", query="SELECT b FROM BcOutNccLb419a b")
