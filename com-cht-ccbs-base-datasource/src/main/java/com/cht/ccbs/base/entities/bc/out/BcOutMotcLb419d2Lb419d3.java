...
/**
 * The persistent class for the bc_out_motc_lb419d2_lb419d3 database table.
 * 
 */
@Entity
@Table(name="bc_out_motc_lb419d2_lb419d3")
@NamedQuery(name="BcOutMotcLb419d2Lb419d3.findAll", query="SELECT b FROM BcOutMotcLb419d2Lb419d3 b")
public class BcOutMotcLb419d2Lb419d3 implements Serializable {
	...
	public BcOutMotcLb419d2Lb419d3() {
	}
