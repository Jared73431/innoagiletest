...
/**
 * The persistent class for the bc_out_ncc_lb419d4_lb419d3 database table.
 * 
 */
@Entity
@Table(name="bc_out_ncc_lb419d4_lb419d3")
@NamedQuery(name="BcOutNccLb419d4Lb419d3.findAll", query="SELECT b FROM BcOutNccLb419d4Lb419d3 b")
public class BcOutNccLb419d4Lb419d3 implements Serializable {
